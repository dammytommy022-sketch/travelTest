...
<head>
  ...
  <title>Visa Confirmation Form</title>
  ...
  <div class="container col-md-9">
    <div class="card shadow m-4">
      ...
      <div class="card-body p-4 p-md-5">
        ...
        <form action="{{ url('visa/submit') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              ...
              <!-- Payment Method -->
              <div class="mb-3">
                <label class="form-label fw-semibold">Make Payment</label>
