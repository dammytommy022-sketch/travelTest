...
(function () {
  ...
  var Br = {
    ...
    ie = function _(A) {
      ...
      function Br(n, t) {
        for (var r = -1, e = null == n, u = t.length, i = Zc(u); ++r < u; )
          i[r] = e ? X : Ia(n, t[r]);
        return i;
      }
      function Ur(n, t, r) {
      ...
      function Zr(n, t, r, e) {
        ...
        r && (t = l(t, E(r))),
          e
            ? ((i = c), (o = !1))
            : t.length >= tn && ((i = W), (o = !1), (t = new cr(t)));
        n: for (; ++u < f; ) {
          var p = n[u],
            v = r ? r(p) : p;
      ...
      function Ae(n, t, r, e, u, i) {
        var o = rh(n),
          ...
          a = Bn,
          c = Bn;
        o || ((a = ps(n)), (a = a == Cn ? Pn : a)),
          f || ((c = ps(t)), (c = c == Cn ? Pn : c));
        var l = a == Pn,
          s = c == Pn,
          h = a == c;
        if (h && !l)
          return (
            i || (i = new hr()),
            o || ch(n) ? ni(n, t, r, e, u, i) : ti(n, t, a, r, e, u, i)
          );
        if (!(u & dn)) {
      ...
      function Le(n) {
        ...
        var t = Ii(n),
          r = [];
        for (var e in n)
          ("constructor" != e || (!t && ol.call(n, e))) && r.push(e);
        return r;
      }
      function Ce(n, t) {
        return n < t;
      ...
      function Ze(n, t, r, e) {
        var u = e ? w : b,
          ...
          o = t.length,
          f = n;
        for (n === t && (t = Ru(t)), r && (f = l(n, E(r))); ++i < o; )
          for (
            var a = 0, c = t[i], s = r ? r(c) : c;
            (a = u(f, s, a, e)) > -1;

          )
            f !== n && wl.call(f, a, 1), wl.call(n, a, 1);
        return n;
      }
      function Ke(n, t) {
      ...
      function Ge(n, t, r, e) {
        for (var u = -1, i = Wl(kl((t - n) / (r || 1)), 0), o = Zc(i); i--; )
          (o[e ? i : ++u] = n), (n += r);
        return o;
      }
      function Je(n, t) {
      ...
      function lu(n, t, r) {
        for (var e = -1, u = n.length; ++e < u; )
          var i = i ? s(Zr(i, n[e], t, r), Zr(n[e], i, t, r)) : n[e];
      ...
      function Du(n, t, e) {
        function u() {
          for (var o = arguments.length, f = Zc(o), a = o, c = fi(u); a--; )
            f[a] = arguments[a];
          var l = o < 3 && f[0] !== c && f[o - 1] !== c ? [] : P(f, c);
          if (((o -= l.length), o < e))
            return Yu(n, t, Nu, u.placeholder, X, f, l, X, X, e - o);
      ...
      function Fu(n) {
        return ei(function (t) {
          ...
          return function () {
            var n = arguments,
              e = n[0];
            if (o && 1 == n.length && rh(e) && e.length >= tn)
      ...
      function Nu(n, t, r, e, u, i, o, f, a, c) {
        function l() {
          for (var y = arguments.length, d = Zc(y), b = y; b--; )
            d[b] = arguments[b];
          if (v)
            var w = fi(l),
              m = B(d, w);
          ...
          return (
            (y = d.length),
            f ? (d = Bi(d, f)) : _ && y > 1 && d.reverse(),
            s && a < y && (d.length = a),
            this && this !== Pr && this instanceof l && (A = g || $u(A)),
            A.apply(j, d)
          );
        }
        var s = t & vn,
      ...
      function Gu(n) {
        return function (t, r, e) {
          return (
            e && "number" != typeof e && mi(t, r, e) && (r = e = X),
            (t = la(t)),
            r === X ? ((r = t), (t = 0)) : (r = la(r)),
            (e = e === X ? (t < r ? 1 : -1) : la(e)),
            Ge(t, r, e, n)
      ...
      function Xu(n, t, r, e, u, i, o, f) {
        ...
        if (
          ...
          (e = p[3]),
          (u = p[4]),
          (f = p[9] = null == p[9] ? (a ? 0 : n.length) : Wl(p[9] - c, 0)),
          !f && t & (ln | sn) && (t &= ~(ln | sn)),
          t && t != fn)
        )
          v =
      ...
      function oi(n) {
        for (
          var t = n.name + "", r = Kl[t], e = ol.call(Kl, t) ? r.length : 0;
          e--;
      ...
      function Ei(n, t) {
        var r = n[1],
          ...
          o =
            (e == vn && r == ln) ||
            (e == vn && r == _n && n[7].length <= t[8]) ||
            (e == (vn | _n) && t[7].length <= t[8] && r == ln);
        if (!i && !o) return n;
      ...
      function Si(n, t, r, e, u, i) {
        return (
          Vf(n) && Vf(t) && (i.set(t, n), $e(n, t, X, Si, i), i.delete(t)), n
        );
      }
      function Wi(n) {
        var t = [];
      ...
      function Li(n, t, e) {
        return (
          ...
          function () {
            for (
              var u = arguments, i = -1, o = Wl(u.length - t, 0), f = Zc(o);
              ++i < o;
      ...
      function Pi(n, t, r) {
        ...
        var e = n ? n.length : 0;
        if (!e || t < 1) return [];
        for (var u = 0, i = 0, o = Zc(kl(e / t)); u < e; )
          o[i++] = Qe(n, u, (u += t));
        return o;
      }
      function qi(n) {
      ...
      function Zi() {
        ...
        if (!n) return [];
        for (var t = Zc(n - 1), r = arguments[0], e = n; e--; )
          t[e - 1] = arguments[e];
      ...
      function Yi(n, t, r, e) {
        var u = n ? n.length : 0;
        return u
          ? (r && "number" != typeof r && mi(n, t, r) && ((r = 0), (e = u)),
            te(n, t, r, e))
          : [];
      }
      function Hi(n, t, r) {
      ...
      function Qi(n, t, r) {
        ...
        var u = e - 1;
        return (
          r !== X && ((u = sa(r)), (u = r < 0 ? Wl(e + u, 0) : Ll(u, e - 1))),
          d(n, ai(t, 3), u, !0)
        );
      }
      function Xi(n) {
      ...
      function ao(n, t, r) {
        ...
        var u = e;
        return (
          r !== X && ((u = sa(r)), (u = u < 0 ? Wl(e + u, 0) : Ll(u, e - 1))),
      ...
      function Zo() {
        ...
        if (n instanceof Et) {
          ...
          return (
            ...
            (t = t.reverse()),
            t.__actions__.push({ func: Do, args: [vo], thisArg: X }),
      ...
      function nf(n, t, r, e) {
        ...
        return (
          r < 0 && (r = Wl(u + r, 0)),
          ua(n) ? r <= u && n.indexOf(t, r) > -1 : !!u && b(n, t, r) > -1
        );
      }
      function tf(n, t) {
        var r = rh(n) ? l : Be;
      ...
      function Af(n, t, r) {
        ...
        return (
          ...
          yf(n, t, { leading: e, maxWait: t, trailing: u })
        );
      }
      function kf(n) {
        return pf(n, 1);
      ...
      function Ta(n, t, r, e) {
        return (
          (e = "function" == typeof e ? e : X), null == n ? n : He(n, t, r, e)
        );
      }
      function $a(n, t, r) {
        var e = rh(n) || ch(n);
      ...
      function qa(n, t, r) {
        return (
          r === X && ((r = t), (t = X)),
          r !== X && ((r = pa(r)), (r = r === r ? r : 0)),
          t !== X && ((t = pa(t)), (t = t === t ? t : 0)),
          Ur(pa(n), t, r)
        );
      }
      function Za(n, t, r) {
        ...
        if ((o && (f += a.length - f), fh(u))) {
          if (n.slice(f).search(u)) {
            var c,
              l = a;
            for (
              u.global || (u = Hc(u.source, ga(Lt.exec(u)) + "g")),
                u.lastIndex = 0;
              (c = u.exec(l));
      ...
      function jc(n, t, r) {
        var e = za(t),
          i = le(t, e);
        null != r ||
          (Vf(t) && (i.length || !e.length)) ||
          ((r = t), (t = n), (n = this), (i = le(t, za(t))));
      ...
      var ts = Lu(ae),
        ...
        hs = Ol
          ...
          : zc,
        ps = pe;
      (($l && ps(new $l(new ArrayBuffer(1))) != Qn) ||
        (Dl && ps(new Dl()) != Fn) ||
        (Ml && ps(Ml.resolve()) != qn) ||
        (Fl && ps(new Fl()) != Kn) ||
        (Nl && ps(new Nl()) != Jn)) &&
      ...
      var vs = el ? qf : Ec,
        ...
        ws = Ye(function (n, t) {
          var r = fo(t);
          return (
            Uf(r) && (r = X), Uf(n) ? Zr(n, fe(t, 1, Uf, !0), ai(r, 2)) : []
          );
        }),
        ms = Ye(function (n, t) {
          var r = fo(t);
      ...
      var Ys = fs(function (n, t) {
          t =
            1 == t.length && rh(t[0]) ? l(t[0], E(ai())) : l(fe(t, 1), E(ai()));
          var e = t.length;
          return Ye(function (u) {
            for (var i = -1, o = Ll(u.length, e); ++i < o; )
      ...
      return (
        ...
        u(["drop", "take"], function (n, t) {
          (Et.prototype[n] = function (r) {
            ...
            return (
              e
                ? (u.__takeCount__ = Ll(r, u.__takeCount__))
                : u.__views__.push({
                    size: Ll(r, En),
        ...
        (Et.prototype.slice = function (n, t) {
          ...
          return r.__filtered__ && (n > 0 || t < 0)
            ...
            : (n < 0 ? (r = r.takeRight(-n)) : n && (r = r.drop(n)),
              t !== X &&
                ((t = sa(t)), (r = t < 0 ? r.dropRight(-t) : r.take(t - n))),
              r);
        }),
          ...
          u &&
            (K.prototype[t] = function () {
              ...
              if (!i && c) {
                ...
                var g = n.apply(t, o);
                return (
                  g.__actions__.push({ func: Do, args: [l], thisArg: X }),
                  new H(g, h)
                );
              }
              return v && _
...
!(function (t) {
  ...
  function s(t, e) {
    ...
    for (
      this.list = t,
        this.options = e = e || {},
        s = 0,
        i = ["sort", "shouldSort", "verbose", "tokenize"],
        n = i.length;
      n > s;
      s++
    )
  ...
  function n(t, e, s) {
    ...
    if (e) {
      if (
        ((h = e.indexOf(".")),
        -1 !== h ? ((i = e.slice(0, h)), (r = e.slice(h + 1))) : (i = e),
        (a = t[i]),
        null !== a && void 0 !== a)
      )
  ...
  function i(t, e) {
    (e = e || {}),
      ...
      (this.options.distance =
        "distance" in e ? e.distance : i.defaultOptions.distance),
      (this.options.threshold =
        "threshold" in e ? e.threshold : i.defaultOptions.threshold),
      (this.options.maxPatternLength =
        e.maxPatternLength || i.defaultOptions.maxPatternLength),
  ...
  (s.VERSION = "2.5.0"),
    ...
    (s.prototype._analyze = function (t, s, n, i) {
      ...
      if (void 0 !== s && null !== s) {
        ...
        if ("string" == typeof s) {
          if (
            ((r = s.split(b.tokenSeparator)),
            b.verbose && e("---------\nKey:", t),
            this.options.tokenize)
          ) {
            for (v = 0; v < this.tokenSearchers.length; v++) {
              for (
                f = this.tokenSearchers[v],
                  b.verbose && e("Pattern:", f.pattern),
                  d = [],
                  y = !1,
                  S = 0;
                S < r.length;
                ...
                var L = {};
                m.isMatch
                  ? ((L[g] = m.score), (_ = !0), (y = !0), h.push(m.score))
                  : ((L[g] = 1), this.options.matchAllTokens || h.push(1)),
                  d.push(L);
              }
            ...
            (_ || u.isMatch) &&
              ...
              a
                ...
                : ((this.resultMap[i] = {
                    item: n,
                    output: [
                      { key: t, score: p, matchedIndices: u.matchedIndices },
                    ],
                  }),
    ...
    (s.prototype._computeScore = function () {
      ...
      for (
        ...
        for (n = 0, o = l[t].output, i = o.length, a = 1, s = 0; i > s; s++)
          (r = o[s].score),
            (h = p ? p[o[s].key].weight : 1),
            (c = r * h),
            1 !== h ? (a = Math.min(a, c)) : ((n += c), (o[s].nScore = c));
        1 === a ? (l[t].score = n / i) : (l[t].score = a),
          this.options.verbose && e(l[t]);
      }
    }),
    ...
    (i.prototype.search = function (t) {
      ...
      if (this.patternLen > M.maxPatternLength) {
        if (
          ((y = t.match(
            new RegExp(this.pattern.replace(M.tokenSeparator, "|"))
          )),
          (k = !!y))
        )
      ...
      for (
        -1 != r &&
          ((i = Math.min(this._bitapScore(0, r), i)),
          (r = t.lastIndexOf(this.pattern, o + this.patternLen)),
          -1 != r && (i = Math.min(this._bitapScore(0, r), i))),
          r = -1,
          g = 1,
          m = [],
          c = this.patternLen + n,
        ...
        for (h = 0, a = c; a > h; )
          this._bitapScore(e, o + a) <= i ? (h = a) : (c = a),
            (a = Math.floor((c - h) / 2 + h));
        for (
          c = a,
            p = Math.max(1, o - a + 1),
            l = Math.min(o + a, n) + this.patternLen,
            u = Array(l + 2),
            u[l + 1] = (1 << e) - 1,
            s = l;
          s >= p;
      ...
      return (
        (S = this._getMatchedIndices(v)),
        { isMatch: r >= 0, score: 0 === g ? 0.001 : g, matchedIndices: S }
      );
    }),
...
function selectIndex(index, autoinput) {
  if (results.length >= index + 1) {
    ...
    const cityElement = $(this).find(".city");
    cityElement.val(results[index].iata);
    });
    clearResults();
  }
}
...
!(function ($) {
  ...
  var DPGlobal = {
    ...
    headTemplate:
      "<thead>" +
      "<tr>" +
      '<th class="prev"><i class="icon mdi mdi-long-arrow-left"></i></th>' +
      '<th colspan="5" class="switch"></th>' +
      '<th class="next"><i class="icon mdi mdi-long-arrow-right"></i></th>' +
      "</tr>" +
      "</thead>",
...
$(function () {
  $(".decrease,.increase").on("click", function () {
    var $qty = $(this)
        .closest(".passenger-dropdown-right")
        .find(".form-control"),
...
(function (t, e) {
  ...
  function e(t) {
    ...
    if (
      (/ladda-button/i.test(t.className) || (t.className += " ladda-button"),
      t.hasAttribute("data-style") ||
        t.setAttribute("data-style", "expand-right"),
        ...
        setProgress: function (e) {
          ...
          0 === e && a && a.parentNode
            ...
            : (a ||
                ...
                (a.className = "ladda-progress"),
                t.appendChild(a)),
              (a.style.width = (e || 0) * t.offsetWidth + "px"));
        },
        enable: function () {
  ...
  function n(t) {
    for (
      var e = ["input", "textarea", "select"], a = [], n = 0;
      e.length > n;
      n++
    )
            ...
            function () {
              ...
              e &&
                ...
                "number" == typeof r.timeout &&
                  (clearTimeout(u), (u = setTimeout(s.stop, r.timeout))),
  ...
  function o(e) {
    ...
    0 === r && (r = parseFloat(window.getComputedStyle(e).height)),
      ...
      e.hasAttribute("data-spinner-lines") &&
        (n = parseInt(e.getAttribute("data-spinner-lines"), 10));
    var i = 0.2 * r,
      o = 0.6 * i,
      s = 7 > i ? 2 : 3;
    return new t({
      ...
      function (e) {
        ...
        if (e.detail.instance == a && !e.defaultPrevented) {
          ...
          (t = d.getAttribute("data-link")) && o(t, !0),
            ...
            (t = d.getAttribute("data-require")) &&
              (a.cfg.requireJs ? a.cfg.requireJs([t]) : o(t)),
