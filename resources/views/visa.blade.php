...
<head>
    ...
    <title>Travelwheel - Visa Search</title>
    <!-- Google Fonts -->
...
<div class="header">
    ...
    <div class="container">
        ...
        <form action="{{ route('initial.search') }}" method="POST" class="visa-search-form" id="visaSearchForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-icon-wrap">
                    ...
                    <input type="text" name="date_range" id="date_range" class="form-control" placeholder="Select dates"
    ...
    <a href="/visa/requirements" class="feature-card-link" style="text-decoration: none; color: inherit;">
    ...
    <!-- Insurance (formerly Visa Services) -->
    <a href="/insurance" class="feature-card-link" style="text-decoration: none; color: inherit;">
        <div class="feature-card">
            <div class="icon"><i class="fa-solid fa-shield-heart"></i></div>
            <h4>Travel Insurance</h4>
            <p>Get reliable travel insurance in minutes and travel stress-free.</p>
        </div>
    </a>

    <!-- Track Application -->
    <a href="/track" class="feature-card-link" style="text-decoration: none; color: inherit;">
        <div class="feature-card">
        ...
        function loadPopularDestinations() {
            $.get('/api/popular-visas', function (data) {
                ...
                <div class="destination-card">
                    <img src="https://flagcdn.com/w80/${visa.country_code.toLowerCase()}.png" class="flag"
...
if (filter === 'tourism') {
    // Restore original options and set Nationality to Nigeria
    ...
    // Restore to_country options (without Nigeria)
    ...
    $toCountry.closest('.input-icon-wrap').css('background', 'var(--card-bg)');
            ...
            // Remove Nigeria from Nationality options
            ...
            // Add Nigeria to to_country if not present
    ...
    // 💥 Trigger click on default filter on page load
    $('.chip[data-filter="tourism"]').trigger('click'); // or "business"
});
        ...
        $('#visaSearchForm').on('submit', function (e) {
            const form = this;
            // Enable both selects before submission
