                ...
                <ul class="navbar-nav  mb-2 mb-lg-0 pe-5">
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link a-nav" href="#">  <i class="fab fa-facebook-f text-muted pt-2"></i></a>

                        </li>
                         <li class="nav-item">

                            <a class="nav-link a-nav" href="#"> <i class="fab fa-twitter text-muted pt-2"></i></a>

                        </li>

                         <li class="nav-item">

                            <a class="nav-link a-nav" href="#"> <i class="fab fa-instagram text-muted pt-2"></i></a>
