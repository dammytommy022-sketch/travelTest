          ...
          <div class="row pb-90 mb-3">
            <div class="nav-align-top ">
              <ul class="nav nav-tabs " role="tablist">
                <li class="nav-item ">
                  <button type="button" class="nav-link btn-sm active" id="touristTab" data-tab="tourist" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-tourist" aria-controls="navs-top-tourist"
                    aria-selected="true">Tourist/Visiting</button>
                </li>
                 <li class="nav-item ">
                  <button type="button" class="nav-link btn-sm" id="voaTab" data-tab="voa"  role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-voa" aria-controls="navs-top-voa"
                    aria-selected="false">Visa on Arraival (VoA)</button>
                </li>
                <li class="nav-item ">
                  <button type="button" class="nav-link btn-sm" id="businessTab" data-tab="business" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-business" aria-controls="navs-top-business"
                    aria-selected="false">Business</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" role="tab" id="studentTab" data-tab="student" data-bs-toggle="tab"
                    data-bs-target="#navs-top-student" aria-controls="navs-top-student"
                    aria-selected="false">Student</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" role="tab" id="transitTab" data-tab="transit" data-bs-toggle="tab"
                    data-bs-target="#navs-top-transit" aria-controls="navs-top-transit"
                    aria-selected="false">Transit</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" id="medicalTab" data-tab="medical" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-medical" aria-controls="navs-top-medical"
                    aria-selected="false">Medical</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" id="wpermitTab" data-tab="wpermit" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-workpermit" aria-controls="navs-top-workpermit" aria-selected="false">Work
                    Permit</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" id="hajjTab" data-tab="hajj" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-hajj" aria-controls="navs-top-hajj" aria-selected="false">Hajj</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" id="conferenceTab" data-tab="conference" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-conference" aria-controls="navs-top-conference"
                    aria-selected="false">Conference</button>
                </li>
                <li class="nav-item">
                  <button type="button" class="nav-link btn-sm" id="immigrateTab" data-tab="immigration" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-cbi" aria-controls="navs-top-cbi" aria-selected="false">Citizenship By
                    Immigration</button>
                </li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane fade show active" id="navs-top-tourist" role="tabpanel">
...
<div class="mt-3">
 ...
 <ul>
                ...
                <div class="tab-pane fade show" id="navs-top-voa" role="tabpanel">
                               <div class="row">
                      <div class="col-lg-6 col-12 mt2 mb-3">
                        <h6>Visa Information</h6>
                        <div class="row">
...
<div class="mt-3">
 ...
 <ul>
                ...
                <div class="tab-pane fade" id="navs-top-business" role="tabpanel">
                     <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                </div>
                <div class="tab-pane fade" id="navs-top-student" role="tabpanel">
                  <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                 
                </div>
                <div class="tab-pane fade" id="navs-top-transit" role="tabpanel">
                   <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                  <p class="mb-0">
                ...
                <div class="tab-pane fade" id="navs-top-medical" role="tabpanel">
                   <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                  <p class="mb-0">
                ...
                <div class="tab-pane fade" id="navs-top-workpermit" role="tabpanel">
                   <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                  <p class="mb-0">
                ...
                <div class="tab-pane fade" id="navs-top-hajj" role="tabpanel">
                   <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                  <p class="mb-0">
                ...
                <div class="tab-pane fade" id="navs-top-conference" role="tabpanel">
                   <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                  <p class="mb-0">
                ...
                <div class="tab-pane fade" id="navs-top-cbi" role="tabpanel">
                   <p>
                    <b>Coming Soon, Under Development</b>
                  </p>
                  <p class="mb-0">
