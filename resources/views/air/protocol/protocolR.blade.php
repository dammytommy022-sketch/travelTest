        ...
        <section class="shadow-sm">
            ...
            <div class="col-sm-4 mb-3">
                    <div class="bg-light p-3 shadow-sm protocol"  >
                            <p style="color: rgba(13, 156, 83, 1);"> <b>Benefits of Our Protocol Services for Regular</b> </p>
                        ...
                        <li class="text-muted"><i class="fa fa-times" style="color:red"></i>
                      ...
                      <form action="{{ route('air.protocol_checkout')}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 text-center">
                                <p>Amount: NGN <span id="selected-option">10,000</span> </p>
