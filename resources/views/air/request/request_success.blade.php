                ...
                <div class="row p-3 pb-5">
                    ...
                    <div class="col-sm-6 pt-3 pb-5">
                        <div class="p-3 text-center">
                           ...
                           <p>You have successfully Sent a Flight Request,
                            Our support service personnel will be in touch with you based on the information provided.</p>
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{route('air.flight')}}">
