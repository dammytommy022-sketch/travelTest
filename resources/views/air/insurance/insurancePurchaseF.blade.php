        ...
        <section class="shadow-sm">
                ...
                <div class="row p-2 pt-5 ">
                    ...
                    <div class="row">
                         <div class="col-xs-3 col-3 col-sm-2 col-lg-1">
                            <img src="../public/assets/img/ppi.png" class="image-fluid w-100" alt="protocol"> 
                         </div>
            ...
            <div class="row airport-form shadow p-4 mb-5">
                ...
                <form action="{{ url('/air/insuranceAllianzPurchase')}}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" id="numberOfDuplicates" name="noc" value="{{$dataRequest->noOfChildren}}" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" name="middlename1" id="middlename" placeholder="Your middlename"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="gender1" aria-label="Default select example" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="title1" aria-label="Default select example" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                @endphp
                                                <input class="form-control" type="date" name="dob1" value="{{ $formattedDate }}"  id="html5-date-input" required/>
                                                @endif
                                            </div>  
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="marital_status1" aria-label="Default select example" required>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3" id="medicalhid">
                                                ...
                                                data-val-length-max="100" id="MedicalCondition" name="MedicalCondition1" type="text" value="" required>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <span id="fullname" class="input-group-text"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" name="middlename2" id="middlename" placeholder="Your middlename"
                                                    aria-describedby="basic-icon-default-fullname2" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <span id="fullname" class="input-group-text"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" name="firstname2" id="firstname" placeholder="Your Firstname"
                                                    aria-describedby="basic-icon-default-fullname2" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="firstname">Gender</label>
                                                <select class="form-select" name="gender2" aria-label="Default select example" required>
                                                        <option value="">-- Select Gender --</option>
                                                        <option value="1">Male</option>
                                                        <option value="2">Female</option>
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="firstname">Title</label>
                                                <select class="form-select" name="title2" aria-label="Default select example" required>
                                                        <option value="">-- Select Title --</option>
                                                        <option value="1">Alhaja</option>
                                                        <option value="2">Alhaji</option>
                                                        <option value="3">Amb.</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                @php
                                                    $formattedDate = \Carbon\Carbon::createFromFormat('Y-m-d\TH:i:s', $dataRequest->dob)->format('Y-m-d');
                                                @endphp
                                                <input class="form-control" type="date" name="dob2" value="{{ $formattedDate }}"  id="html5-date-input" required/>
                                                @endif
                                            </div>  
                                            <!-- \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $dataRequest->dob)->format('d F Y')                        -->
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <span id="fullname" class="input-group-text"><i class="fa fa-envelope"></i></span>
                                                    <input type="text" class="form-control" name="email2" id="email" value="{{$dataRequest->email}}" required placeholder="Email Address"
                                                    aria-describedby="basic-icon-default-fullname2"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <span id="fullname" class="input-group-text"><i class="fa fa-phone"></i></span>
                                                    <input type="text" class="form-control" name="phone_no2" id="phone_no" value="{{$dataRequest->phone_no}}" required placeholder="Your phone number"
                                                    aria-describedby="basic-icon-default-fullname2"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3" id="medicalhid">
                                                ...
                                                <input class="form-control text-box single-line" data-val="true" data-val-length="The field 
                                                Details of Medical Conditions must be a string with a maximum length of 100." 
                                                data-val-length-max="100" id="MedicalCondition" name="MedicalCondition2" type="text" required value="">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <span id="fullname" class="input-group-text"><i class="fa fa-user"></i></span>
                                                        <input type="text" class="form-control" name="middlenameC" id="middlename" placeholder="Your middlename"
                                                        aria-describedby="basic-icon-default-fullname2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <span id="fullname" class="input-group-text"><i class="fa fa-user"></i></span>
                                                        <input type="text" class="form-control" name="firstnameC" id="firstname" placeholder="Your Firstname"
                                                        aria-describedby="basic-icon-default-fullname2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label" for="firstname">Gender</label>
                                                    <select class="form-select" name="genderC" aria-label="Default select example" >
                                                            <option value="">-- Select Gender --</option>
                                                            <option value="1">Male</option>
                                                            <option value="2">Female</option>
                                                    </select>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label" for="firstname">Title</label>
                                                    <select class="form-select" name="titleC" aria-label="Default select example" >
                                                            <option value="">-- Select Title --</option>
                                                            <option value="1">Alhaja</option>
                                                            <option value="2">Alhaji</option>
                                                            <option value="3">Amb.</option>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="date" name="dobC" value=""  id="html5-date-input" />
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="mb-3" id="medicalhid">
                                                    ...
                                                    <input class="form-control text-box single-line" data-val="true" data-val-length="The field 
                                                    Details of Medical Conditions must be a string with a maximum length of 100." 
                                                    data-val-length-max="100" id="MedicalCondition" name="MedicalConditionC" type="text" value="" >
                                                </div>
...
<script>
    function duplicateFormElements() {
        ...
        const originalCard = document.querySelector('.child');
        ...
        for (let i = 1; i <= numberOfDuplicates; i++) {
            ...
            newCard.querySelector('h6').textContent = `Child ${i}`; // Update the child number in the duplicated card
