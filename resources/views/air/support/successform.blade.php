...
<body class="d-flex justify-content-center align-items-center vh-10">
  ...
  <div class="card shadow-lg text-center p-5" style="max-width: 500px;">
    ...
    <p class="mt-3">Thank you for your payment. Your request has been received successfully.</p>
    ...
    <div class="mt-4">
      <a href="{{ route('air.support_ticket') }}" class="btn btn-main px-4 py-2 rounded-pill">Return to Support Form</a>
    </div>
  </div>
