...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-passport"></i> Create New Visa</h1>
        </div>
        ...
        <div class="form-wrapper">
            ...
            <form id="visaForm" class="form-content" action="/admin/visas/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="section active" data-section="1">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="processing_days" min="1" max="90" placeholder="Enter processing days" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Validity Days</label>
                            <input type="number" class="form-control" name="validity_days" min="1" max="365" placeholder="Enter validity period" required>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-wrapper">
                                <input type="checkbox" class="checkbox-input" name="requires_flight" id="requires_flight" value="1">
                        ...
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-wrapper">
                                <input type="checkbox" class="checkbox-input" name="requires_hotel" id="requires_hotel" value="1">
                                <div class="checkbox-custom"></div>
                            </div>
                        ...
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-wrapper">
                                <input type="checkbox" class="checkbox-input" name="requires_insurance" id="requires_insurance" value="1">
                                <div class="checkbox-custom"></div>
                            </div>
                   ...
                   <div class="form-group">
    <label class="form-label">Fillable Form</label>
    <div class="form-grid">
        <div class="form-group">
            <label>
                <input type="radio" name="form_type" value="upload" checked> Upload Form
            </label>
            <div class="form-file-upload" id="fileUpload" ondragover="handleDragOver(event)" ondrop="handleDrop(event)">
                ...
                <input type="file" class="form-control" name="form_file" accept="application/pdf" style="display: none;" onchange="handleFileSelect(event)">
                    ...
                    <div class="form-group">
                            ...
                            <textarea class="form-control" name="note" rows="4" cols="50" placeholder="Enter note"></textarea>
                        </div>
                </div>
                ...
                <div class="section" data-section="2">
                    ...
                    <div class="fee-grid">
                        <div class="fee-card">
                            ...
                            <input type="number" class="form-control" name="visa_fee_adult" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                        <div class="fee-card">
                            <div class="fee-icon">
                            ...
                            <input type="number" class="form-control" name="visa_fee_child" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                        <div class="fee-card">
                            <div class="fee-icon">
                            ...
                            <input type="number" class="form-control" name="visa_fee_infant" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                    </div>
                    ...
                    <div class="fee-grid">
                        <div class="fee-card">
                            ...
                            <input type="number" class="form-control" name="biometrics_fee_adult" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                        <div class="fee-card">
                            <div class="fee-icon">
                                <i class="fas fa-fingerprint"></i>
                            ...
                            <input type="number" class="form-control" name="biometrics_fee_child" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                        <div class="fee-card">
                            <div class="fee-icon">
                                <i class="fas fa-fingerprint"></i>
                            ...
                            <input type="number" class="form-control" name="biometrics_fee_infant" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="admin_fee" min="0" step="0.01" placeholder="Enter admin fee" required>
                    </div>
                    <div class="checkbox-group">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="checkbox-input" name="pay_fees" id="embassy_pay">
                                            <div class="checkbox-custom"></div>
                                        </div>
                     ...
                     <div class="checkbox-group">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="checkbox-input" name="pay_bio_fees" id="embassy_bio_pay">
                                            <div class="checkbox-custom"></div>
                                        </div>
                    ...
                    <div class="charges-container">
                        ...
                        <div id="chargesContainer">
                            <div class="charge-item" data-index="0">
    <div class="charge-header">
        <div class="charge-number">1</div>
        <button type="button" class="remove-charge" style="display: none;">
    ...
    <div class="form-grid">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="other_charges[0][charge_name]" placeholder="Enter charge name" >
        </div>
        <div class="form-group">
            <label class="form-label">Amount (USD)</label>
            <input type="number" class="form-control charge-amount" name="other_charges[0][amount]" min="0" step="0.01" placeholder="0.00" >
        </div>
        <div class="form-group">
            <label class="form-label">Traveler Type</label>
            <div class="select-wrapper">
                <select class="form-control" name="other_charges[0][traveler_type]" >
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="other_charges[0][note]" placeholder="Optional notes" rows="2"></textarea>
        </div>
        <div class="checkbox-group">
            <input type="hidden" name="other_charges[0][pay_to_embassy]" value="0">
            <div class="checkbox-wrapper">
                <input type="checkbox" class="checkbox-input" name="other_charges[0][pay_to_embassy]" id="embassy_0" value="1">
                <div class="checkbox-custom"></div>
            </div>
            <label for="embassy_0">Pay to Embassy</label>
        </div>
    </div>
</div>
                        </div>
                        ...
                        <div class="total-summary">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    ...
                                    <div class="total-amount" id="totalCharges">$0.00</div>
                                </div>
            ...
            <div class="document-selector">
                ...
                <div class="document-grid" id="documentsGrid">
                    <div class="document-card" data-doc-id="1">
                        ...
                        <p style="color: var(--text-secondary); font-size: 0.9rem; margin: 0;">Original passport with at least 6 months validity</p>
                        <p style="color: var(--text-secondary); font-size: 0.9rem; margin: 0;">Category: visa</p>
                    </div>
                    <!-- Other document cards remain unchanged -->
                </div>
    ...
    <!--    <button type="button" class="save-btn" id="quickSave" title="Quick Save">-->
    ...
    checkboxes.forEach(name => {
        ...
        if (!checkbox.checked) {
            ...
            checkbox.value = '1'; // Ensure checked checkboxes send '1'
        }
    });
    ...
    document.querySelectorAll('input[name*="other_charges"][name*="pay_to_embassy"]').forEach(checkbox => {
        if (checkbox.checked) {
            checkbox.value = '1'; // Explicitly set checked value to '1'
        }
        // Hidden input already ensures '0' when unchecked
    });
});
        // Load countries
        async function loadCountries() {
            try {
                ...
                if (data.data) {
                    ...
                    select.innerHTML = '<option value="" disabled>No countries available</option>';
                }
            } catch (error) {
                console.error('Error loading countries:', error);
                document.getElementById('country_id').innerHTML = '<option value="" disabled>Error loading countries</option>';
            }
        }
 ...
 function saveNewDocument() {
    ...
    const docId = Date.now().toString(); // Ensure unique ID
    const docHTML = `
    ...
    const newDocCard = document.querySelector(`.document-card[data-doc-id="${docId}"]`);
    newDocCard.classList.add('selected');

    // Add to selectedDocuments if not already present
    ...
    if (docCard.classList.contains('selected')) {
        ...
        // Select the document if not already in selectedDocuments
        if (!selectedDocuments.some(doc => doc.id === docId)) {
        ...
        function generateReview() {
            ...
            reviewHTML += `
                <div class="review-section">
                    ...
                    <div class="review-grid">
                        ...
                        ${formData.get('form_file') ? '<div><strong>Form Uploaded:</strong> Yes</div>' : '<div><strong>No Form Uploaded</strong></div>'}
                    </div>
                </div>
            `;
            ...
            reviewHTML += `
                <div class="review-section">
                    <h4><i class="fas fa-file-alt" style="margin-right: 0.5rem;"></i>Required Documents (${selectedDocs.length})</h4>
                    <div class="doc-list">
            `;
            selectedDocs.forEach(doc => {
                const title = doc.querySelector('h5').textContent.trim();
                reviewHTML += `<div class="doc-item"><i class="fas fa-check-circle" style="color: var(--success); margin-right: 0.5rem;"></i>${title}</div>`;
            });
            reviewHTML += '</div></div>';
            reviewHTML += '</div>';
            ...
            let previewHTML = `
                <div class="preview-card">
                    ...
                    <div class="preview-details">
                        ...
                        ${formData.get('form_file') ? '<p><strong>Form Uploaded:</strong> Yes</p>' : '<p><strong>No Form Uploaded</strong></p>'}
                    </div>
                </div>
            `;
