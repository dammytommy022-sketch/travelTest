          ...
          <tr>
            <td style="padding:30px;">
              ...
              <div style="text-align:center; margin-top:25px;">
                <a href="https://admin.travelwheel.com/support/requests" style="display:inline-block; background:#1369FF; color:#fff; text-decoration:none; padding:12px 28px; border-radius:6px; font-size:15px;">
                  View in Dashboard
                </a>
              </div>
            </td>
