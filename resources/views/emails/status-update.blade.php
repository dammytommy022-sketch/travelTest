...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <div class="info-box">
            <p>Your application {{ $application->application_id }} status has been updated to: {{ $application->status }}</p>
@if($application->visa_document_path)
    <p><a href="{{ url('storage/' . $application->visa_document_path) }}">Download your visa document</a></p>
@endif
<p>Visit <a href="{{ route('track.application') }}">Track Application</a> for more details.</p>
            </div>
