...
<head>
    ...
    <title>Yellow Card Application</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        .main-color { color: rgba(13, 24, 131, 1); }
        .price-text { font-size: 2.5rem; font-weight: bolder; color: rgba(13, 24, 131, 1); }
...
<body class="m-3 bg-light">
    ...
    <div class="container col-md-9">
        ...
        <div class="card shadow m-4">
            ...
            <div class="card-body">
                <form id="yellowCardForm" method="POST" action="{{ route('yellow_card.submit') }}" enctype="multipart/form-data">
